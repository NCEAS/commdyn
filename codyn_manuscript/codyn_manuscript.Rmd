...
#####Turnover
Quick sentence on richness (Figure 1a)
Total turnover indicates that in general there were greater fluctuations in the species present in the unburned than burned location at Konza.Parsing total turnover by appearances and disappearances indicates that there were generally more appearances in the unburned than burned location. In addition, total turnover strongnly diverged between locations in 1995 was because the burned location lost many species that year, while the unburned locations lost none (Figure 2b).

```{r results='asis'}
KNZ_total_turnover <- turnover(df = collins08, 
                          species.var = "species",
                          time.var = "year",
