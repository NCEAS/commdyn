# read in CAP arthropods site by species table
sxs <- read.table("siteXspecies_CAP_arthropods.txt")

# -- make a grouping data frame and a species table
sxs.groups <- sxs[,c("site_id", "sample_date")]
spp.list <- names(sxs)[c(-1,-2)]
dat.spp <- sxs[,spp.list]
